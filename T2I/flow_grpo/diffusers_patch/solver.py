...
def run_sampling_img2img(
    ...
    """
    Run sampling for img2img pipeline with potentially trimmed sigma schedule.
    
    This is identical to run_sampling but handles the case where sigma_schedule
    is already trimmed for img2img (doesn't start from sigma=1.0).
    """
    return run_sampling(v_pred_fn, z, sigma_schedule, solver, determistic, eta)
